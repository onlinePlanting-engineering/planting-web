...
class VegMeta(models.Model):
    ...
    seed_price = models.DecimalField(default=0.0)
    mature_price = models.DecimalField(default=0.0)
...
class VegMetaImage(models.Model):
    ...
    def __str__(self):
        return '{meta} - {image}'.format(meta=self.vegmeta.name, image=self.image.url)